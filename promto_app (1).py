...
with st.form("form_promto"):
    ...
    if submitted:
        ...
        st.success("✅ Checklist generado. Descarga abajo:")
        st.download_button("📥 Descargar Checklist Word", buffer, file_name=f"Checklist_PROMTO_{receptor_nombre.replace(' ', '_')}_{donador_nombre.replace(' ', '_')}.docx")
